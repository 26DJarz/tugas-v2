  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="home.php"><span>RENTAL PERKASA</span></a>
      </div>
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
          <li><a  href="home.php">Pelayanan</a></li>
          <li><a  href="home.php">Organisations</a></li>
          <li><a  href="home.php">Tentang Alat Kami</a></li>
          <li><a  href="home.php">Kontak Kami</a></li>
...
<!--    end of signup form-->
    ...
    <center><div class="heading"><h1>Tentang Kami</h1></div></center><hr>
    <div class="content">
     RENTAL PERKASA adalah tempat untuk menyewa alat besar seperti Exavator, Buldozer, dan Crane.
    
    Perusahaan kami telah berdiri sejak 2008 dan kami sudah memiliki banyak pelanggan.</div>
   <hr>
     <div class="parallax" style="background-image:url('dump.jpg')"></div>
...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
  ...
  <footer id="footer" class="footer">
    <div class="container text-center">
      ...
      <h3>Berikan Saran Kepada Kami</h3>

      <form class="mc-trial row" action="review.php" method="get">
        <div class="form-group col-md-3 col-md-offset-2 col-sm-4">
          <div class=" controls">
            <input name="username" placeholder="Masukkan Username" class="form-control" type="text">
          </div>
        </div>
        <!-- End email input -->
        <div class="form-group col-md-3 col-sm-4">
          <div class=" controls">
            <input name="comment" placeholder="Masukkan Saran Anda" class="form-control" type="text">
          </div>
        </div>
        <!-- End email input -->
      ...
      <div class="credits">
        ...
        -->
        Designed by <a href="https://amoldalwai.com/">RAMADHAN</a>
      </div>
    </div>
  </footer>
  <!--/ Footer-->
